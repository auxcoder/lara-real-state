<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="mt-1 w-full block" type="password" name="password" required autocomplete="new-password" />
        ...
        <div class="justify-end mt-4 flex items-center">
            <x-primary-button>
                {{ __('Reset Password') }}
            </x-primary-button>
        </div>
